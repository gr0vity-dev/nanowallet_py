...
class TestNanoPrecision(unittest.TestCase):
    def test_very_small_amounts(self):
        ...
        self.assertEqual(
            raw_to_nano(999999999), Decimal("0.000000000000000000000999999999")
        )
    ...
    def test_rounding_behavior(self):
        ...
        self.assertEqual(
            raw_to_nano(nano_to_raw("0.1234567891234567891234567891234")),
            Decimal("0.123456789123456789123456789123"),
        )

        # Test that trailing zeros are handled correctly
        self.assertEqual(
            raw_to_nano(nano_to_raw("1.100000000000000000000000000000")),
